  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        <h1 className="text-8xl font-display text-gradient-aurora">404</h1>
        <h2 className="mt-4 text-xl font-display">Page not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This route hasn't been trained yet.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Ankit Jha — ML Engineer & CS Student" },
      {
        name: "description",
        content:
          "Portfolio of Ankit Jha — aspiring Machine Learning Engineer focused on NLP, classification, and applied AI.",
      },
      { name: "author", content: "Ankit Jha" },
    ],
    links: [
